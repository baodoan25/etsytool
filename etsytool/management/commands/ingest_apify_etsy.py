...
from etsytool .data_engine .apify_runner import tao_du_lieu_chay ,chay_actor_etsy 
from etsytool .data_engine .storage import nhap_cac_muc_tho ,ghi_cac_muc_chay_tho 
...
class Command (BaseCommand ):
    ...
    def handle (self ,*args ,**options ):
        ...
        raw_path =ghi_cac_muc_chay_tho (ket_qua ["runId"],ket_qua ["items"])
        ingest_result =nhap_cac_muc_tho (ket_qua ["items"],nguon ="apify")

        self .stdout .write (self .style .SUCCESS (f"Apify run completed: {ket_qua ['runId']}"))
        self .stdout .write (f"Dataset: {ket_qua ['datasetId']}")
