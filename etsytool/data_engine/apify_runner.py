...
def build_run_input(start_urls, max_items=1000, end_page=1, include_description=False):
    return {
...
def run_etsy_actor(start_urls, max_items=1000, end_page=1, include_description=False, actor_id=None, token=None):
